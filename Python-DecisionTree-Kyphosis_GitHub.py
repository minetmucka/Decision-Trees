...
#Data Source: kyphosis.csv                                                      #
#Python Version: 3.4+                                                           #
#Using Packages: scikit-learn, pandas, numpy,  pydotplus, matplotlib            #
#################################################################################
...
kyphosis = pd.read_csv('C://Users//muckam//Desktop//DataScienceBootcamp//Datasets//kyphosis.csv', index_col=0)
